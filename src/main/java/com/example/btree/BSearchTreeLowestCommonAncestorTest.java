...
public class BSearchTreeLowestCommonAncestorTest {

    public static void main(String[] args) {
        BTreeNode<Integer> root = createTree1();
        BTreePrinter.print(root);
        BTreeNode<Integer> node = BSearchTreeLowestCommonAncestor.find(root, 3, 11);
        System.out.println("期望9, 实际" + node.data);
        node = BSearchTreeLowestCommonAncestor.find(root, 10, 20);
        System.out.println("期望11, 实际" + node.data);
        node = BSearchTreeLowestCommonAncestor.find(root, 1, 10);
        System.out.println("期望9, 实际" + node.data);
        node = BSearchTreeLowestCommonAncestor.find(root, 1, 8);
        System.out.println("期望3, 实际" + node.data);
        node = BSearchTreeLowestCommonAncestor.find(root, 8, 20);
        System.out.println("期望9, 实际" + node.data);
        node = BSearchTreeLowestCommonAncestor.find(root, 4, 5);
        System.out.println("期望null, 实际" + node);

        root = createTree2();
        BTreePrinter.print(root);
        node = BSearchTreeLowestCommonAncestor.find(root, 2, 9);
        System.out.println("期望8, 实际" + node.data);

        node = BSearchTreeLowestCommonAncestor.find(null, 2, 9);
        System.out.println("期望null, 实际" + null);


        root = createTree3();
        BTreePrinter.print(root);
        node = BSearchTreeLowestCommonAncestor.find(root, 3, 7);
        System.out.println("期望null, 实际" + null);

        root = createTree4();
        BTreePrinter.print(root);
        node = BSearchTreeLowestCommonAncestor.find(root, 10, 11);
        System.out.println("期望null, 实际" + null);
    }

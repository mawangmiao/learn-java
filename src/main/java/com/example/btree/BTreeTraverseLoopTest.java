...
public class BTreeTraverseLoopTest {
    ...
    private static void traverseAndPrint(BTreeNode<Integer> root) {
        ...
        List<BTreeNode<Integer>> list = BTreeTraverseLoop.preOrderTraverse(root);
        System.out.print("前序遍历: ");
        print(list);
        list = BTreeTraverseLoop.inOrderTraverse(root);
        System.out.print("中序遍历: ");
        print(list);
        list = BTreeTraverseLoop.postOrderTraverse(root);
